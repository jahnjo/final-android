...
public class filteredResults6 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.filtered_results_layout5);
        ...
        mainListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                ...
                final Intent intent = new Intent(filteredResults6.this, item.class);
...
//                            startActivity(intent);
    ...
    public void clickHomeWithinFilteredResults(View v) {
        if(v.getId() == R.id.homeButtonWithinFilteredResults) {
            Intent i = new Intent(filteredResults6.this, MainActivity.class);
            startActivity(i);
        }
    }
}