...
public class filteredResults5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.filtered_results_layout4);
        ...
        mainListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                ...
                final Intent intent = new Intent(filteredResults5.this, item.class);
...
//                            startActivity(intent);
    ...
    public void clickHomeWithinFilteredResults(View v) {
        if(v.getId() == R.id.homeButtonWithinFilteredResults) {
            Intent i = new Intent(filteredResults5.this, MainActivity.class);
            startActivity(i);
        }
    }
}